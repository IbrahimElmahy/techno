import{bZ as o,c0 as p}from"./index-Dfwo2csU.js";const n={nameAr:"تكنو ثيرم",nameEn:"TechnoTherm — German Technology",activity:"أنظمة السباكة والتغذية",address:"قطعة 676 امتداد المنطقة الصناعية السادسة — مدينة السادس من أكتوبر",phones:["01062240047","01020275910"],email:""};function l(){return[n.nameEn,n.activity,n.address,`ت: ${n.phones.join(" - ")}`,"","",n.email].filter(Boolean)}const c=`
