import{b$ as o,c2 as p}from"./index-DcI_U2D_.js";const i={nameAr:"تكنو ثيرم",nameEn:"TechnoTherm — German Technology",activity:"أنظمة السباكة والتغذية",address:"قطعة 676 امتداد المنطقة الصناعية السادسة — مدينة السادس من أكتوبر",phones:["01062240047","01020275910"],email:""};function l(){return[i.nameEn,i.activity,i.address,`ت: ${i.phones.join(" - ")}`,"","",i.email].filter(Boolean)}const c=`
