...
class ReceiptIn(BaseModel):
    ...
    # ١..٥٠، فالرقم لوحده مش بيحدد كوبون. بتتساب فاضية والنظام يستنتجها من الدفتر
    # اللي اتصرف منه — اللي بيستلم مابيختارش فئة الورقة اللي في إيده.
...
def check_serial(
    ...
    coupon_kind: str | None = Query(None, description="فئة الدفتر — الرقم لوحده مش كافي"),
