...
class ReceiptIn(BaseModel):
    ...
    # نوع الدفتر اللي الأرقام دي منه. الذهبي والفضي كل واحد مرقّم ١..٥٠، فالرقم لوحده
    # مش بيحدد كوبون — من غير النوع كوبون فضي ممكن يتحسب على فاتورة صرفت ذهبي.
...
class ReceiptLineOut(BaseModel):
    id: int
    serial: str
    # النوع مع الرقم: «٥ ذهبي» غير «٥ فضي»، والرقم لوحده مايفرقش بينهم.
    coupon_type_id: int | None = None
...
def _out(r) -> ReceiptOut:
    return ReceiptOut(
        ...
        lines=[ReceiptLineOut(id=ln.id, serial=ln.serial,
                              coupon_type_id=ln.coupon_type_id,
...
def check_serial(
    ...
    coupon_type_id: int | None = Query(None, description="نوع الدفتر — الرقم لوحده مش كافي"),
    ...
    """
    return coupon_receipt_service.check_serial(db, serial, coupon_type_id)
...
def create_receipt(
    ...
    try:
        ...
        receipt = coupon_receipt_service.create_receipt(
            ...
            customer_type=body.customer_type, coupon_type_id=body.coupon_type_id,
        )
