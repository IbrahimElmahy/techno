...
_ADDED_COLUMNS: list[tuple[str, str, str]] = [
    ...
    # مديونية النوع التاني (أبيض/بولي) وقت الترحيل — الشرح في `models/sales.py`.
    ...
    # (038) فئة الأصناف بقت شجرة: الفئة ليها أب اختياري في نفس القايمة، و`NULL` = رئيسية.
    #
    # ⚠️ العمود ده **مش اختياري في النشر**: `lookup_option` بتتقري من كل منسدلة في
    # النظام، والموديل بقى بيعلن العمود — فلو اتنشر الكود من غير العمود، أي `SELECT`
    # على الجدول بيقع، يعني كل قايمة في كل شاشة. لازم يمشوا مع بعض.
